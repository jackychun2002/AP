...
namespace T2008M.Session5
{
    public class Program
    {
        public static void Main(string[] args)
        {
            // tao thread void static func
            Thread t = new Thread(ShowMsg);// truyen function se chay khi luon moi khoi tao
            t.Start();//chuyen sang runnable
